...
UE.parse.register('list',function(utils){
    ...
    utils.extend(this,{
        liiconpath : 'http://bs.baidu.com/listicon/',//UEDITOR_CONFIG.listiconpath,
        ...
        if (typeof SyntaxHighlighter == "undefined") {
            ...
            function aa(i) {
                if (i < jsurlAry.length) {
                    ...
                    utils.cssRule('my-syntaxhlt', '.syntaxhighlighter{font-size:14px!important;}.syntaxhighlighter .line.alt1{background-color:#f0f0f0!important;}.syntaxhighlighter .line.alt2{background-color:#f7f7f7!important;}.syntaxhighlighter table td.code .line{padding:0 4px!important;}.syntaxhighlighter.nogutter td.code .line,gutter td.code .container textarea{padding-left:4px!important}.syntaxhighlighter code,.syntaxhighlighter div,.syntaxhighlighter table,.syntaxhighlighter table caption,.syntaxhighlighter table tbody,.syntaxhighlighter table td,.syntaxhighlighter table thead,.syntaxhighlighter table tr,.syntaxhighlighter textarea{line-height:1.3em!important}');
